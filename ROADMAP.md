...
Continue P1-06 with aggregate (including fixed-array), pattern and closure lowering. P1-07 now has a
...
bounded cross-package scalar calls and ownership-aware lowering before P1-10
closes the full differential denominator. Completing a foundation PR does not
mark its entire milestone complete.
