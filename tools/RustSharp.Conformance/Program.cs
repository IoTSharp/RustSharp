...
internal static class Program
{
    ...
    private static Options ParseOptions(string[] args)
    {
        ...
        if (profile is not ProfileName and not SafeCoreLexingProfileName and
            not SafeCoreSyntaxProfileName and not SafeCoreNameResolutionProfileName and not SafeCorePrimitivesProfileName and not SafeCoreTypeProfileRunner.ProfileName and not SafeCoreGenericProfileRunner.ProfileName)
        {
            throw new ArgumentException(
                $"Supported profiles are '{ProfileName}', '{SafeCoreLexingProfileName}', '{SafeCoreSyntaxProfileName}', '{SafeCoreNameResolutionProfileName}', '{SafeCorePrimitivesProfileName}', '{SafeCoreTypeProfileRunner.ProfileName}', and '{SafeCoreGenericProfileRunner.ProfileName}'.");
        }
